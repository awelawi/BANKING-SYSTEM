...
button_subtract = Button(root, text="-", padx=41, pady=20,command=lambda: ButtonSub())
button_multiply = Button(root, text="*", padx=40, pady=20,command=lambda: ButtonMult())
button_divide = Button(root, text="/", padx=41, pady=20,command=lambda: ButtonDivide())
